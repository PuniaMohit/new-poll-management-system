...
import UpdatePollOption from "./components/UpdatePollOption/updatePollOption";
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route
        exact
        path="/updatePollTitle/:pollTitle/:pollId"
        element={<UpdatePollTitle />}
      />
      <Route
        exact
        path="/updatePollOption/:option/:optionId"
        element={<UpdatePollOption />}
      />
